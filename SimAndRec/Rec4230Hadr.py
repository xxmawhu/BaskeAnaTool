...
class Rec4230Hadr(zeus) : 
    def __init__(self):
        ...
        zeus.AddOpt(self,\
            "line_13",\
            "$MDCHOUGHFINDERROOT/share/jobOptions_MdcPatTsfHoughRec.txt",\
        ...
        zeus.SetOpt(self,'EventCnvSvc', 'digiRootInputFile',' {"/scratchfs/bes/zhuan/MCcard/init/init/../rtraw/09_PsiptoLambdaLambdabarPhi/PsiptoLambdaLambdabarPhi_000.rtraw"}')
        zeus.SetOpt(self,'EventCnvSvc', 'digiRootOutputFile',' "/scratchfs/bes/maxx/Psi2S/LLPhi/12/dst/dst_0001.dst"')
        zeus.SetOpt(self,'ApplicationMgr', 'EvtMax','10000')
        zeus.SetOpt(self,'BesRndmGenSvc', 'RndmSeed',' 1 ')
