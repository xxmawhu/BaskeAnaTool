...
class RecJPsi(zeus) : 
    def __init__(self):
        ...
        zeus.SetOpt(self,'EventCnvSvc', 'digiRootInputFile',' {"/scratchfs/bes/kangxianwei/maxx/rtraw/J_PPGG/sim_001.rtraw"}')
        zeus.SetOpt(self,'EventCnvSvc', 'digiRootOutputFile','"/scratchfs/bes/kangxianwei/maxx/dst/J_PPGG/sim_001.dst"')
